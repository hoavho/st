...
static const char *colorname[] = {
	/* 8 normal colors */
	[0] = "#585e6b", // rgb(88, 94, 107)   //Ansi 0 Color
	[1] = "#db090f", // rgb(219, 9, 15)    //Ansi 1 Color
	[2] = "#8cb371", // rgb(140, 179, 113) //Ansi 10 Color
	[3] = "#d4b373", // rgb(212, 179, 115) //Ansi 11 Color
	[4] = "#83afd8", // rgb(131, 175, 216) //Ansi 12 Color
	[5] = "#c074d6", // rgb(192, 116, 214) //Ansi 13 Color
	[6] = "#50a7b3", // rgb(80, 167, 179)  //Ansi 14 Color
	[7] = "#f1f1ef", // rgb(241, 241, 239) //Ansi 15 Color
